...
if __name__ == "__main__":
   URLS()
   print("Tiempo de la descarga {}".format(timeit.Timer(multihilos).timeit(number=1)))
   print('---------------')
   print("Tiempo de la descarga {}".format(timeit.Timer(Multiproceso).timeit(number=1)))
   print('----------------')
   print("Tiempo de la descarga {}".format(timeit.Timer(normal).timeit(number=1)))